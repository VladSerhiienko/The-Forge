...
const char* pszRoots[] = {
    "../SceneViewer/" RESOURCE_DIR "/Binary/",          // FSR_BinShaders
    "../SceneViewer/" RESOURCE_DIR "/",                 // FSR_SrcShaders
    "../SceneViewer/" RESOURCE_DIR "/Binary/",          // FSR_BinShaders_Common
    "../SceneViewer/" RESOURCE_DIR "/",                 // FSR_SrcShaders_Common
    "../../Examples_3/SceneViewer/Resources/Textures/", // FSR_Textures
    "../../Examples_3/SceneViewer/Resources/Meshes/",   // FSR_Meshes
    "../../Examples_3/SceneViewer/Resources/Fonts/",    // FSR_Builtin_Fonts
    "",                                                 // FSR_OtherFiles
};
...
public:
    ...
    void Exit()
    {
        ...
        if ( pScene ) {
            ...
            for ( auto pMesh : pScene->meshes ) {

                if ( pMesh.pIndexBuffer ) {
                    removeResource( pMesh.pIndexBuffer );
                }
            ...
            /*for ( auto pImage : pScene->images ) {
                pImage->Destroy( );
                delete pImage;
            }*/

            for ( auto pTexture : pScene->textures ) {
